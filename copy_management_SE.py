# copy the sediment input rasters at the *positions in the following database structure:
...
####tree branch periode
############################  copy sediment input rasters to .../Periode/Einzel ################################
count = 0
...
#copy e.g. sediment input rasters of Frienisberg_07_17_SE to new created folder Frienisberg/Frienisberg_2007_2017/Periode/Einzel
...
for org in origin_list:
    ...
    newbase_name = "sum_" + org_name + "_SE.tif"
    print(newbase_name)
...
for SE_ras in specific_Jahr_list:
    ...
    # set new_basename for output path
    newbase_name = "sum_" + gebperi_name + "_"+ year + "_SE.tif"
    print(newbase_name)
...
for SE_ras in specific_Jahr_list:
    ...
    # set new_basename for output path
    newbase_name = "sum_" + gebperi_name + "_"+ date + "_SE.tif"
    print(newbase_name)
...
for SE_ras in specific_Jahr_list:
    ...
    # set new_basename for output path
    newbase_name = "sum_" + gebperi_name + "_"+ ero_Name + "_SE.tif"
    print(newbase_name)
...
for SE_ras in parz_nr_list:
    ...
    # set new_basename for output path
    newbase_name = "sum_" + gebperi_name + "_P"+ parz_Name + "_SE.tif"
    print(newbase_name)
